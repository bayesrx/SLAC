...
The coefficient corresponding to negative interaction between points of type 1 and points of type 2 is highly statistically significant. While this should be taken with a grain of salt, since this is influenced by the ratio of auxiliary points to observed points, this method yields reasonable results in this case, as the other two interaction coefficients are small and not statistically significant.
